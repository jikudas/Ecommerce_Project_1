			...
			<div class="mainheading">
				...
				<div class="row post-top-meta">
					<div class="col-md-2 pr-0">
						<a href="author.html" class="d-flex justify-content-center">
							<img class="author-thumb" src="<?= 'https://cdn.easyfie.com/' . $me->avatar ?>" alt="Sal">
						</a>
					</div>
					<div class="col-md-10">
						<span class="author-description"><?= $me->about ?></span>
						<span class="post-date"><?php echo date("d M Y", $value->data->posted); ?></span><span class="dot"></span><span class="post-read"><?php echo ($value->data->view) ?> views</span>
					</div>
				</div>
				<!-- End Top Menta -->

				<h1 class="posttitle"><?= $value->data->name; ?></h1>

			</div>

			<!-- Begin Featured Image -->
			<img class="featured-image img-fluid" src="<?= 'https://cdn.easyfie.com/' . $value->data->image ?>" alt="">
			<!-- End Featured Image -->
