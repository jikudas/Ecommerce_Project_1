<?php
$latestProducts = $easyfie->ProductsOrBlogs($token, 'products', 9, 'desc');
?>
...
<section class="product_section layout_padding">
   <div class="container">
      <div class="heading_container heading_center">
         <h2>
            Latest <span class="title">Products</span>
         </h2>
      </div>
      <div class="row">
         <?php $show = 1; ?>
         <?php foreach ($latestProducts->data as $key => $product) {
            ...
            <?php if ($product->remark == '') { ?>
               <div class="col-sm-6 col-md-4 col-lg-4" data-aos="fade-down-left">
                  <div class="box">
